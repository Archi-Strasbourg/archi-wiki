        ...
        switch ($archiAffichage) {
                ...
                switch ($_GET['tableName']) {
                    ...
                    case 'quartier':
                        ...
                        echo $generateur->afficheFormulaireListe(
                            array_merge(
                                $_GET,
                                array('modeAffichageLienDetail'=>"adminAdresseDetail",
            ...
            case 'adresseDetail':
                ...
                if (isset($_GET['archiIdEvenementGroupeAdresse'])
                    &&$_GET['archiIdEvenementGroupeAdresse']!=''
                ) {
                ...
                if (isset($_GET['archiIdEvenementGroupeAdresse'])
                    &&!empty($_GET['archiIdEvenementGroupeAdresse'])
                    &&$_GET['archiIdEvenementGroupeAdresse']!=''
                ) {
        ...
        // Cas de l'ajout d'un nouveau dossier
            ...
            case 'modifierImage':
                ...
                echo $a -> afficherFormulaireModification(
                    0,
                    '',
                    array($_GET['archiIdImageModification'])
                );
                break;
            ...
            case 'modifierImageAdresse':
                $a = new archiImage();
                echo $a -> afficherFormulaireModification(
                    $_GET['archiIdAdresseModification'],
                    'adresse'
                );
                break;
