...
class calqueObject extends ArchiConfig
{
		...
		// renvoi une "popup" qui ne peut pas etre boug� et dont le fond couvre toute la page internet , et transparent
		...
		// a placer a la fin du code de la page, permet de deplace la fenetre cr��e par l'objet
		...
		// ici si un div de la page est afficher , on va scoller jusqua 4731 , sinon si le div est ferm� on scroll jusqu'a 175
		// ***************************************************************************************************************************************
		public function getJsScrollDivWithPage($params = array())
		{
			...
			{
				$conditionsToScrollBegin=$params['conditionsToScrollBegin']."{"; // les accolades de la condition sont ajout�es automatiquement
				$conditionsToScrollEnd="}";
			}
